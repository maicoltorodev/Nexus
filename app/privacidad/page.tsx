      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="space-y-8 text-gray-300 leading-relaxed font-light">
          ...
          <section className="space-y-4">
            ...
            <p>
              Implementamos medidas de seguridad técnicas y organizativas para proteger tus datos contra el acceso no autorizado, pérdida o alteración. No vendemos ni compartimos tu información con terceros con fines comerciales.
            </p>
          </section>
