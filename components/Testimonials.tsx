...
export default function Testimonials() {
  ...
  return (
    <section id="testimonios" className="relative py-24 overflow-hidden" style={{ background: 'linear-gradient(180deg, #0a0a0a 0%, #1a1a1a 100%)' }}>
      {/* Efecto de fondo decorativo */}
      <div className="absolute inset-0 opacity-5">
        <div className="absolute top-0 right-1/4 w-96 h-96 bg-[#FFD700] rounded-full blur-3xl"></div>
        <div className="absolute bottom-0 left-1/4 w-96 h-96 bg-[#FFA500] rounded-full blur-3xl"></div>
      </div>
